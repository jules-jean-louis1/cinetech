<header class="bg-[#1f0c19] text-white">
    ...
    <div class="block md:hidden py-2">
        <div class="flex items-center justify-between px-2">
            <div>
                <button id="btnHeaderMenu" type="button" class="bg-[#9c4ef4] hover:bg-[#8241cc] text-white rounded-lg px-2 py-1">Menu</button>
            </div>
            <div id="containerMenuResponsive" class="hidden">
                <nav class="bg-[#1f0c19] absolute z-40 h-full w-1/2 left-0 mt-6">
                    <ul class="flex flex-col gap-6 px-6">
                        <li>
                            <a href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/cinetech';?>" class="flex items-center gap-5">
                        ...
                        <li>
                            <a href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/cinetech/movie';?>" class="flex items-center gap-5">
                        ...
                        <li>
                            <a href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/cinetech/series';?>" class="flex items-center gap-5">
