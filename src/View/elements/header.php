        ...
        <nav class="flex justify-between items-center px-6">
            <div>
                <ul class="flex items-center space-x-4">
                    <li>
                        <a href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/cinetech/';?>">
                    ...
                    <li><a href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/cinetech/movie';?>" class="uppercase">Film</a></li>
                    <li><a href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/cinetech/series';?>" class="uppercase">Series</a></li>
                </ul>
            </div>
                        ...
                        <ul id="menuProfilHeader" class="absolute right-0 w-36 mt-0.5  bg-[#9c4ef4] rounded-lg border-[1px] border-[#a8b3cf33] shadow-lg z-10 hidden ">
                            <li>
                                <button id="btnHeaderProfile" type="button" class="bg-[#9c4ef4] hover:bg-[#8241cc] text-white rounded-lg px-2 w-full">
                                    <a href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/cinetech/profil';?>" class="flex items-center justify-between">
        ...
        <div id="containerMenuResponsive" class="hidden">
            <nav class="bg-[#1f0c19]/20 absolute z-40 h-full w-1/2 left-0 top-16 backdrop-blur-lg">
                <ul class="flex flex-col gap-6 px-6 mt-4">
                    <?php if (isset($_SESSION['id'])) { ?>
                        <li>
                            <button id="btnHeaderProfile" type="button" class="text-white rounded-lg px-2 w-full">
                                <a href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/cinetech/profil';?>" class="flex items-center justify-between">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user-circle" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                        <path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0"/>
                    ...
                    <?php } ?>
                    <li>
                        <a href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/cinetech';?>" class="flex items-center gap-4 font-bold text-xl text-white">
                    ...
                    <li>
                        <a href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/cinetech/movie';?>" class="flex items-center gap-4 font-bold text-xl text-white">
                    ...
                    <li>
                        <a href="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . '/cinetech/series';?>" class="flex items-center gap-4 font-bold text-xl text-white">
