...
<!--    <script defer type="module" src="<?php /*echo 'https://' . $_SERVER['HTTP_HOST'] . '/cinetech/public/script/script_index.js';*/?>"></script>
    ...
    <script defer type="module" src="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/cinetech/public/script/script_index.js';?>"></script>
    ...
    <title>Acceuil - WatchManager</title>
</head>
